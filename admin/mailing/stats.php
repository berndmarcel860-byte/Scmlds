...
$per_page  = 50;
$filter    = in_array($_GET['filter'] ?? '', ['','pending','sent','failed','bounced']) ? ($_GET['filter'] ?? '') : '';
...
<div class="admin-main">
    ...
    <div class="admin-content p-4">
        ...
        <div class="row g-3 mb-4">
            <?php
            $kpis = [
                ['primary',   'Gesamt',       $stats['total'],   null],
        ...
        <div class="card border-0 shadow-sm" id="recipients">
            ...
            <div class="table-responsive">
                <table class="table table-sm table-hover align-middle mb-0">
                    ...
                    <tr><td colspan="8" class="text-center text-muted py-4">Keine Einträge.</td></tr>
                    <?php endif; ?>
