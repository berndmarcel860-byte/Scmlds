...
<nav class="navbar-d1">
  <div class="container d-flex align-items-center justify-content-between">
    ...
    <a href="#contact-form" class="btn-nav-cta">Kostenlos prüfen →</a>
  </div>
</nav>
    ...
    <div class="row align-items-center">
      <div class="col-lg-7">
        ...
        <div class="d-flex flex-wrap gap-3 mt-4">
          <a href="#contact-form" class="btn-hero-primary">Jetzt kostenlos starten →</a>
...
setupForm('mainForm','design1');setupForm('engForm','design1_modal');
